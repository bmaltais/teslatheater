    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file, 10, 36, 351);
    			attr_dev(a1, "href", "https://www.crave.ca/en");
    			add_location(a1, file, 10, 2, 317);
    			...
    			add_location(img2, file, 11, 51, 483);
    			attr_dev(a2, "href", "https://www.disneyplus.com/fr-ca/login");
    			add_location(a2, file, 11, 2, 434);
    			...
    			add_location(img3, file, 12, 40, 607);
    			attr_dev(a3, "href", "https://www.crave.ca/en/hbo");
    			add_location(a3, file, 12, 2, 569);
    			...
    			add_location(img4, file, 13, 32, 718);
    			attr_dev(a4, "href", "https://tv.bell.ca/");
    			add_location(a4, file, 13, 2, 688);
    			...
    			add_location(img5, file, 14, 33, 838);
    			attr_dev(a5, "href", "https://netflix.com/");
    			add_location(a5, file, 14, 2, 807);
    			...
    			add_location(img6, file, 15, 46, 969);
    			attr_dev(a6, "href", "https://www.paramountplus.com/ca/");
    			add_location(a6, file, 15, 2, 925);
    			...
    			add_location(img7, file, 16, 32, 1095);
    			attr_dev(a7, "href", "https://ici.tou.tv/");
    			add_location(a7, file, 16, 2, 1065);
    			...
    			add_location(img8, file, 17, 32, 1208);
    			attr_dev(a8, "href", "https://tubitv.com/");
    			add_location(a8, file, 17, 2, 1178);
    			...
    			add_location(img9, file, 18, 35, 1327);
    			attr_dev(a9, "href", "https://www.twitch.com");
    			add_location(a9, file, 18, 2, 1294);
    			...
    			add_location(img10, file, 19, 40, 1450);
    			attr_dev(a10, "href", "https://tv.virginmobile.ca/");
    			add_location(a10, file, 19, 2, 1412);
    			...
    			add_location(img11, file, 20, 36, 1575);
    			attr_dev(a11, "href", "https://www.youtube.com");
    			add_location(a11, file, 20, 2, 1541);
    			add_location(p2, file, 9, 1, 311);
    			attr_dev(p3, "id", "demo1");
    			add_location(p3, file, 22, 1, 1667);
    			add_location(script, file, 23, 1, 1687);
